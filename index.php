...
<body>
    <?php include 'nav.php'; ?>
      ...
      <div class="destaque">
             Promoção de Fim de Semana: até 80% OFF em jogos AAA!
      </div> 
    <main>
        <section class="grade-jogos">
            <div class="card-jogo">
                <h2>Battlefield 6</h2>
                <img src="./imagens/battlefield 6 index.jpg" alt="Battlefield 6">
            ...
            <div class="card-jogo">
                ...
                <p>Enfrente horrores ainda mais intensos em uma nova jornada de sobrevivência.</p>
                <button>Comprar</button>
                </div>
        </section>
    </main>
